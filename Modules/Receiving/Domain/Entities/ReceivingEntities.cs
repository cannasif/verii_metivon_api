...
public sealed class GoodsReceipt:Entity{public string ReceiptNumber{get;set;}=string.Empty;public GoodsReceiptType ReceiptType{get;set;}public GoodsReceiptStatus Status{get;set;}public long BranchId{get;set;}public long? SupplierId{get;set;}public long? PurchaseOrderId{get;set;}public PurchaseOrder? PurchaseOrder{get;set;}public long? TradeDossierId{get;set;}public long WarehouseId{get;set;}public Warehouse Warehouse{get;set;}=null!;public string? SupplierDeliveryNoteNumber{get;set;}public DateOnly ReceiptDate{get;set;}public DateTime? PostedAt{get;set;}public Guid? InventoryPostingId{get;set;}public string? Notes{get;set;}public ICollection<GoodsReceiptLine> Lines{get;set;}=new List<GoodsReceiptLine>();public ICollection<GoodsReceiptPurchaseOrder>PurchaseOrders{get;set;}=new List<GoodsReceiptPurchaseOrder>();}
public sealed class GoodsReceiptPurchaseOrder:Entity{public long GoodsReceiptId{get;set;}public GoodsReceipt GoodsReceipt{get;set;}=null!;public long PurchaseOrderId{get;set;}public PurchaseOrder PurchaseOrder{get;set;}=null!;}
