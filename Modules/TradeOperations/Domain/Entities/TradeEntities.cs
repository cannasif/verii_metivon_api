...
public sealed class TradeDossier : Entity
{
    ...
    public long CurrencyId { get; set; } public Currency Currency { get; set; } = null!; public string CurrencyCode { get; set; } = "USD"; public string IncotermCode { get; set; } = "FOB"; public string? PaymentMethodCode { get; set; } public string? DeliveryMethodCode { get; set; }
